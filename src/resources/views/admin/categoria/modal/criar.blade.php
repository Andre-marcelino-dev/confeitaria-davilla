          ...
          <form method="POST" action="{{ route('admin.categoria.store') }}">
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control" id="descricao_categoria" rows="3" aria-describedby="alerta-descricao" name="descricao_categoria" Required></textarea>
              ...
              <div class="mb-3">
                <div class="row">
                  <div class="col-6">
                    <label for="nome_categoria" class="form-label">Ordem</label>
                  ...
                  <div class="col-6">
                    ...
                    <select class="form-select" aria-label="Selecione uma opção" name="status_categoria" id="status_categoria" ria-describedby="alerta-ordem_categoria" Required>
